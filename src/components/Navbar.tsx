        ...
        <div className="flex items-center justify-between h-16 sm:h-20">
          ...
          <div className="flex items-center gap-0.5 xs:gap-1.5 sm:gap-2">
            ...
            <motion.button
              ...
              transition={{ duration: 0.1 }}
              onClick={onOpenShop}
              className="hidden sm:flex items-center gap-1.5 px-3 py-2 rounded-xl cursor-pointer transition-all border border-amber-200 dark:border-amber-800 bg-amber-50 dark:bg-amber-950/20 hover:bg-amber-100 dark:hover:bg-amber-950/40 hover:shadow-lg hover:shadow-amber-500/10"
              title="Tanga do'koni"
            >
